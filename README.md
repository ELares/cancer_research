...
- **Book-format manuscript (~270 pp at 6x9 trim)** with 12 chapters, 3 appendices, and 47 figures (~82,000 words), cross-referenced against all analysis outputs and indexed in [`FIGURES.yaml`](FIGURES.yaml)
