...
- **Book-format manuscript (~117 pp)** with 11 chapters, 3 appendices, and 22 figures (~36,700 words), cross-referenced against all analysis outputs
...
| `article/drafts/` | Manuscript (v1.md + v1.tex) with 22 figures |
...
| `tests/` | 108 Python tests (pipeline smoke + figure traceability + manuscript-inventory drift guard + invariant/integration + calibrate-extractor + ferroptosis-python bindings) |
