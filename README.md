...
- **Book-format manuscript (~115 pp)** with 11 chapters, 3 appendices, and 24 figures (~56,500 words), cross-referenced against all analysis outputs and indexed in [`FIGURES.yaml`](FIGURES.yaml)
