...
- **Book-format manuscript (~115 pp)** with 12 chapters, 3 appendices, and 24 figures (~60,300 words), cross-referenced against all analysis outputs and indexed in [`FIGURES.yaml`](FIGURES.yaml)
...
| `article/drafts/` | Manuscript (v1.md + v1.tex) with 24 figures; [`FIGURES.yaml`](FIGURES.yaml) indexes 32 entries, the extra 8 being supplementary and one orphan |
