...
- **13 Rust simulation binaries**, a mechanistic claim-testing engine covering
  **ten treatment arms plus an untreated control**: ferroptosis induction
  ...
  7 modules and 1144 lines against the ferroptosis engine's 27 modules and
  3,992, so the newer arms are roughly 4 to 4 times smaller — measured in
...
- **Book-format manuscript (~270 pp at 6x9 trim)** with 12 chapters, 3 appendices, and 36 figures (~69,700 words), cross-referenced against all analysis outputs and indexed in [`FIGURES.yaml`](FIGURES.yaml)
...
| preregistered predictions | **8 of 18** | 0 | — |
...
8 of 18 preregistered predictions, and 33 of 38 modules of the simulation engine, concern ferroptosis or the physical-ROS modalities (PDT and
...
8 of 18 rather than the 8 of 8 it read for most of this project's life. None of
...
| `article/drafts/` | Manuscript (v1.md + v1.tex) with 36 figures; [`FIGURES.yaml`](FIGURES.yaml) indexes 41 entries, the extra 4 being supplementary and 1 orphan |
