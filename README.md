...
- **13 Rust simulation binaries**, a mechanistic claim-testing engine covering
  **ten treatment arms plus an untreated control**: ferroptosis induction
  ...
  9 modules and 1558 lines against the ferroptosis engine's 26 modules and
...
- **Book-format manuscript (~270 pp at 6x9 trim)** with 12 chapters, 3 appendices, and 40 figures (~73,600 words), cross-referenced against all analysis outputs and indexed in [`FIGURES.yaml`](FIGURES.yaml)
