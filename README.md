...
- **Book-format manuscript (~115 pp)** with 12 chapters, 3 appendices, and 29 figures (~60,900 words), cross-referenced against all analysis outputs and indexed in [`FIGURES.yaml`](FIGURES.yaml)
...
| `article/drafts/` | Manuscript (v1.md + v1.tex) with 29 figures; [`FIGURES.yaml`](FIGURES.yaml) indexes 34 entries, the extra 5 being supplementary and one orphan |
