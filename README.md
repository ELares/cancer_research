...
- **Book-format manuscript (~270 pp at 6x9 trim)** with 12 chapters, 3 appendices, and 44 figures (~77,800 words), cross-referenced against all analysis outputs and indexed in [`FIGURES.yaml`](FIGURES.yaml)
...
| preregistered predictions | **10 of 26** | 0 | — |
...
| `article/drafts/` | Manuscript (v1.md + v1.tex) with 44 figures; [`FIGURES.yaml`](FIGURES.yaml) indexes 49 entries, the extra 5 being 4 supplementary and 1 orphan |
