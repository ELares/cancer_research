...
- **Book-format manuscript (~115 pp)** with 11 chapters, 3 appendices, and 24 figures (~53,900 words), cross-referenced against all analysis outputs and indexed in [`FIGURES.yaml`](FIGURES.yaml)
...
| `article/drafts/` | Manuscript (v1.md + v1.tex) with 24 figures; [`FIGURES.yaml`](FIGURES.yaml) indexes 30 entries, the extra 6 being supplementary and one orphan |
...
For the simulations (see [simulations/README.md](simulations/README.md) for all 12 binaries):
