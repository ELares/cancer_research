...
- figure traceability index (FIGURES.yaml) mapping all 26 figures to generators, inputs, and types (3 new quantitative simulation figures from #285: hypoxia kill-collapse, Bliss synergy, treatment-timing window)
...
FIGURES.yaml                                 figure-to-script traceability index (26 figures)
