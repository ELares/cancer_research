...
- tumor microenvironment: oxygen gradients (edge-distance proxy, explicit internal vessel network #191, or patient-scale planar depth gradient #240), spatial immune zones (DAMP diffusion, T cell activation, anti-PD-1, T-cell exhaustion #243, Treg/MDSC suppressor field #264), LP overshoot multiplier, CAF-mediated stromal protection (GSH/MUFA supply), pH gradient (iron release + drug ion trapping)
