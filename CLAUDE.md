...
- manuscript: ~117 pages (book format), 11 chapters + 3 appendices, 22 figures, ~36,700 words
...
- figure traceability index (FIGURES.yaml) mapping all 25 figures to generators, inputs, and types (2 new Tier-1 quantitative figures: #285 hypoxia kill-collapse + Bliss synergy)
...
FIGURES.yaml                                 figure-to-script traceability index (25 figures)
