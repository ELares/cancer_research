...
- tumor microenvironment: oxygen gradients (edge-distance proxy or explicit internal vessel network #191), spatial immune zones (DAMP diffusion, T cell activation, anti-PD-1, T-cell exhaustion #243), LP overshoot multiplier, CAF-mediated stromal protection (GSH/MUFA supply), pH gradient (iron release + drug ion trapping)
