...
def render(d: dict) -> str:
    ...
    if not d["rows"]:
        L.append(
            ...
            f"{d['census']:,} census records. No terms for the modalities "
            "without MeSH descriptors matched these input titles or abstracts. "
            "No trial shares or literature-age comparisons are available.\n"
        )
        return "\n".join(L)
    L.append(
        f"Generated by `scripts/census_unnamed_modalities.py` over "
