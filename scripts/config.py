...
MECHANISM_KEYWORDS = {
    ...
    # Emerging regulated-cell-death modalities (#347). Added to the taxonomy as a
    # next-pass scaffold; the frozen 19-mechanism manuscript results are NOT
    # re-tagged (the corpus INDEX.jsonl is not regenerated by adding these).
    "cuproptosis": [
        "cuproptosis", "copper-induced cell death", "copper-dependent cell death",
        "cuproptotic", "elesclomol", "copper ionophore", "fdx1",
    ],
    "disulfidptosis": [
        "disulfidptosis", "disulfide stress", "disulfide-induced cell death",
        "disulfidptotic", "slc7a11 disulfide", "actin cytoskeleton disulfide",
    ],
}
