...
figs = {
    ...
    '20': ('fig23_prisma_flow', 'PRISMA-inspired corpus construction flow. 10,415 unique PubMed records across 19 mechanism queries; 4,830 full-text articles indexed (803 journals, 2001--2026), 5,585 abstract-only records retained separately. No manual screening or exclusion criteria were applied; this is an automated keyword-driven pipeline, not a formal systematic review.'),
