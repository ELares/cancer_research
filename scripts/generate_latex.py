...
figs = {
    ...
    '14': ('fig17_damp_heatmap', 'DAMP concentration field after immune coupling (O$_2$ gradient $\\lambda$=120$\\mu$m). SDT saturates the tumor field; RSL3 produces sparse hotspots.'),
}
