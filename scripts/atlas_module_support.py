...
The atlas supplies the denominator. For each module, this asks the census's
typed relation layer (its size is derived at render time from the layer's own
manifest, because it was hand-written here once and went stale by a third when
the layer was re-ingested):
...
def main() -> None:
    ...
    L = [
        ...
        f"graph: {_relation_scale()} typed relations over the cancer-article "
        "PMIDs they were extracted from.", "",
        "## Why", "",
