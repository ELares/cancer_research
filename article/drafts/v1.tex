...
\textbf{Evidence level:} Original-research-like articles were classified into one of seven tiers: (1) Phase III clinical trial or randomized controlled trial, (2) Phase II clinical trial, (3) Phase I clinical trial, (4) non-phase clinical / patient-series evidence, (5) preclinical in vivo, (6) preclinical in vitro, or (7) theoretical/computational. Review-like articles and protocols were intentionally left unclassified rather than being forced into an evidence tier. Classification was based on keyword detection plus publication-type metadata for the highest level of evidence reported in each article.
...
\textbf{Immune residual-disease strategies} --- especially TIL/TCR-style cell therapy, mRNA or neoantigen vaccination, and phagocytosis-checkpoint manipulation --- are important because they aim not just to kill a vulnerable state, but to convert residual disease into an immune-recognizable target.
