...
\caption{DAMP spatial distribution after immune coupling (O$_2$ gradient $\lambda$=120$\mu$m, per-panel scaling). SDT saturates the tumor field; RSL3 produces sparse hotspots.}
