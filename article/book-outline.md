...
**Target:** ~59,000 words (current: ~81,300 measured prose-only from v1.md by `tests/test_book_outline_wordcount.py`, which recomputes it and fails on drift). 5 Parts, 12 chapters, 3 appendices.
...
| III: Simulations | 5-9 | ~43,100 | 21,500 |
| IV: What's Next | 10-12 | ~8,100 | 11,500 |
| V: References/Tools | Apps A-C | ~7,700 | 8,000 |
| front matter (title, abstract) | — | ~2,000 | — |
| **Total** | **12 + 3 apps** | **~81,300** | **~59,000** |
