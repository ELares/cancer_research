...
**Target:** ~54,000 words (current: ~48,500, measured prose-only from v1.md by `tests/test_book_outline_wordcount.py`, which recomputes it and fails on drift). 5 Parts, 11 chapters, 3 appendices.
...
| II: What We Found | 3-4 | ~10,400 | 12,000 |
