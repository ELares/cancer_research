...
**Target:** ~59,000 words (current: ~82,400 measured prose-only from v1.md by `tests/test_book_outline_wordcount.py`, which recomputes it and fails on drift). 5 Parts, 12 chapters, 3 appendices.
...
| II: What We Found | 3-4 | ~16,900 | 12,000 |
