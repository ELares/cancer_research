---
url: https://www.sciencedaily.com/releases/2026/03/260303201807.htm
canonical_url: https://www.sciencedaily.com/releases/2026/03/260303201807.htm
source_domain: sciencedaily.com
tier: 2
tier_name: Science journalism
title: A simple hand photo may be the key to detecting a serious disease
date_published: null
content_hash: sha256:b9aa4cd3959d0655f1b2b84923d8993e9ef60d7f2e7787ba99b3e9737ef51ecd
paywall: false
claims:
- id: sciencedaily.com-undated-undated-a-simple-hand-photo-may-be-the-k-001
  text: In total, 725 patients from 15 medical institutions across Japan contributed
    more than 11,000 images used to train and test the AI model.
  type: result
  category: FACTUAL
  ...
  - '42020452'
  - '42020425'
- id: sciencedaily.com-undated-undated-a-simple-hand-photo-may-be-the-k-002
  text: 'In their study, they describe the technology as a way to "complement clinical
    expertise, reduce diagnostic oversight and enable earlier intervention."

    Study lead Fukuoka says: "We believe that, by further developing this technology,
    it could lead to creating a medical infrastructure during comprehensive health
    check-ups to connect suspected cases of hand-related disorders to specialists.'
  type: speculation
  category: SPECULATIVE
  verification_status: null
  verification_source: null
  linked_pmids: []
- id: sciencedaily.com-undated-undated-a-simple-hand-photo-may-be-the-k-003
  text: Increases are expected to be largest in countries where ...
  type: speculation
  category: SPECULATIVE
  verification_status: null
  verification_source: null
  linked_pmids: []
- id: sciencedaily.com-undated-undated-a-simple-hand-photo-may-be-the-k-004
  text: "Life Expectancy Since 1943\nJune 23, 2021 Â\x97\nU.S. life expectancy decreased\
    \ by 1.87 years between 2018 and 2020, according to new research."
  type: opinion
...
The team reported their results in the
Journal of Clinical Endocrinology & Metabolism
. Their AI model demonstrated very high sensitivity and specificity when identifying acromegaly from the hand images. In direct comparisons, the system even performed better than experienced endocrinologists who evaluated the same photographs.
...
APA
Chicago
Kobe University. "A simple hand photo may be the key to detecting a serious disease." ScienceDaily. ScienceDaily, 4 March 2026. <www.sciencedaily.com
/
releases
/
2026
...
/
260303201807.htm
Kobe University. "A simple hand photo may be the key to detecting a serious disease." ScienceDaily. www.sciencedaily.com
/
releases
/
2026
