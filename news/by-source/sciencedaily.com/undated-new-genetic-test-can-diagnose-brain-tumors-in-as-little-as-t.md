---
url: https://www.sciencedaily.com/releases/2025/05/250520224245.htm
canonical_url: https://www.sciencedaily.com/releases/2025/05/250520224245.htm
source_domain: sciencedaily.com
tier: 2
tier_name: Science journalism
title: New genetic test can diagnose brain tumors in as little as two hours
date_published: null
content_hash: sha256:f6066112bfd5f6611f1d66c0bcc58b7e98d98127b70962dcd347f89b14aa7c0a
paywall: false
claims:
- id: sciencedaily.com-undated-undated-new-genetic-test-can-diagnose-br-001
  text: This approach has achieved a 100% success rate, providing diagnostic results
    in under two hours from surgery and detailed tumor classifications within minutes
    of sequencing.
  type: result
  category: FACTUAL
  ...
  linked_pmids: []
- id: sciencedaily.com-undated-undated-new-genetic-test-can-diagnose-br-002
  text: This approach has achieved a 100% success rate, providing diagnostic results
    in under two hours from surgery and detailed tumour classifications within minutes
    of sequencing.
  type: result
  category: FACTUAL
  verification_status: unverified
  verification_source: null
  linked_pmids: []
- id: sciencedaily.com-undated-undated-new-genetic-test-can-diagnose-br-003
  text: 'Patients find waiting many weeks for results extremely difficult and this
    adds to the anxiety and worry at what is already a very difficult time."

    "This type of operation can be quite long, so potentially, a surgeon could be
    informed during surgery of the accurate diagnosis, which would then impact on
    the surgical strategy."

    The current treatment pathway starts with an MRI scan to ascertain the presence
    of a tumour, patients will speak to clinicians to discuss the possibilities of
...
The groundbreaking method, which is detailed in a new study published today in
Neuro-Oncology,
has been developed by scientists at the University of Nottingham along with clinicians at Nottingham University Hospitals NHS Trust (NUH).
...
Every day in the UK 34* people are diagnosed with some form of brain tumour, equating to more than 12,000 cases a year. The average survival rate can be less than a year for the most aggressive brain cancers.
...
Traditionally experts would then look at the specimens and the neuropathology view would be to try and identify the cells visually. But in the last few years the process has changed and tumours are categorised on the DNA and genetic abnormalities -- which traditionally is a slow process due to technological limitations.
...
Professor Loose said: "When we first were able to sequence an entire human genome in 2018, it took around five labs and six months to do, which obviously isn't ideal when time is of the essence for a patient. This new method now allows us to choose the bits of DNA that we need to look at in order to answer specific questions, such as what type of tumour and how can it be treated. Combined with our later research where we were able to look at relevant parts of the human genome more quickly -- then we now have a process where we can use ROBIN to create comprehensive classifications of tumours more quickly.
...
APA
Chicago
University of Nottingham. "New genetic test can diagnose brain tumors in as little as two hours." ScienceDaily. ScienceDaily, 21 May 2025. <www.sciencedaily.com
/
releases
/
2025
...
/
250520224245.htm
University of Nottingham. "New genetic test can diagnose brain tumors in as little as two hours." ScienceDaily. www.sciencedaily.com
/
releases
/
2025
...
05
/
250520224245.htm (accessed April 22, 2026).
Explore More
from ScienceDaily
RELATED STORIES
