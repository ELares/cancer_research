...
canonical_url: https://www.who.int/news-room/fact-sheets/detail/cancer
source_domain: who.int
tier: 1
tier_name: Institutional and peer-adjacent
title: Cancer
date_published: null
content_hash: sha256:1da26995c7ce3599c74b2be6e12b83507957c2f2d28eaf86259a70abb42c6216
paywall: false
claims:
- id: who.int-undated-undated-cancer-001
  text: "Cancer-causing infections, such as human\n            papillomavirus (HPV)\
    \ and hepatitis, are responsible for approximately\n            30% of cancer\
    \ cases in low- and lower-middle-income countries."
  type: result
  category: FACTUAL
  verification_status: self-referencing
  verification_source: institutional authority (who.int)
  linked_pmids: []
- id: who.int-undated-undated-cancer-002
  text: "Approximately 10% of cancers diagnosed in 2022 globally were attributed to\
    \ carcinogenic infections, including Helicobacter pylori, human\n        papillomavirus\
  ...
  verification_source: institutional authority (who.int)
  linked_pmids: []
- id: who.int-undated-undated-cancer-003
  text: 'Reducing the burden

    Approximately 38% of cancers can currently be prevented by avoiding risk factors
  ...
  verification_source: institutional authority (who.int)
  linked_pmids: []
- id: who.int-undated-undated-cancer-004
  text: Some of the most common cancer types, such as breast cancer, cervical cancer,
    oral cancer, and colorectal cancer, have high cure probabilities when detected
  ...
  linked_pmids: []
- id: who.int-undated-undated-cancer-005
  text: Relief from physical, psychosocial, and spiritual problems through palliative
    care is possible for more than 90% of patients with advanced stages of cancer.
  type: mechanism
  category: FACTUAL
  verification_status: self-referencing
  verification_source: institutional authority (who.int)
  linked_pmids: []
- id: who.int-undated-undated-cancer-006
  text: "Improved access to oral morphine is strongly recommended for the treatment\n\
    \    of moderate to severe cancer pain, suffered by over 80% of people with cancer\
...
(1)
. The most common in 2022 (in terms of new cases of cancer) were:
...
The incidence of cancer rises dramatically with age, most likely due to cumulative exposure to risk factors that increase with age. The overall risk accumulation is combined with the tendency for cellular repair mechanisms to be less effective as
...
Some chronic infections are risk factors for cancer; this is a particular issue in low- and middle-income countries. Approximately 10% of cancers diagnosed in 2022 globally were attributed to carcinogenic infections, including Helicobacter pylori, human
        papillomavirus (HPV), hepatitis B virus, hepatitis C virus, and Epstein-Barr virus
(2).
Hepatitis B and C viruses and some types of HPV increase the risk for liver and cervical cancer, respectively. Infection with HIV increases the risk of developing cervical cancer six-fold and substantially increases the risk of developing selected other
        cancers such as Kaposi sarcoma.
Reducing the burden
Approximately 38% of cancers can currently be prevented by avoiding risk factors and implementing existing evidence-based prevention strategies. The cancer burden can also be reduced through early detection of cancer and appropriate treatment and care
...
There is, however, a significant variation in treatment availability between countries of different income levels; most countries do not fully include essential cancer care services – including prevention, screening, diagnosis, treatment and palliative care – in their publicly-financed health-benedfit packages, highlighting significant gaps on the path to universal health coverage
(3).
Palliative care
...
Improved access to oral morphine is strongly recommended for the treatment
    of moderate to severe cancer pain, suffered by over 80% of people with cancer in the terminal phase.
WHO response
In 2017, the World Health Assembly passed the
Resolution Cancer prevention and control in the context of an integrated approach (WHA70.12)
that urges
        governments and WHO to accelerate action to achieve the targets specified in the
Global Action Plan for the prevention and control of NCDs 2013-2020
and the 2030 UN Agenda for Sustainable Development to reduce premature mortality from cancer.
WHO and IARC collaborate with other UN organizations, including the International Atomic Energy Agency, and partners to:
...
support governments to improve survival for childhood cancer through directed country support, regional networks and global action as part of the WHO Global Initiative for Childhood Cancer using the Cure
All
approach;
...
(3)
WHO global survey on the inclusion of cancer care in health-benefit packages, 2020–2021. Geneva: World Health Organization; 2024.