...
| treatment | O2 | immune | block | metric | seed 42 | median | historical 95% bootstrap interval | min-max |
|---|---|---|---|---|---|---|---|---|
...
Block 0 is the manuscript's condition. Its median defined ratio is
107:1, compared with the historical single-run 104:1. This proximity
does not establish representativeness across independent runs.

What the single seed hides is the spread: **49:1 to 260:1**, a
5-fold range, and in **1 of 20** seeds the RSL3 denominator
is zero so the ratio is undefined altogether.

A descriptive reading of these saved results is
"~110:1 among defined ratios, ranging roughly 49:1 to 260:1 across the recorded roots and
...
```bash
python scripts/seed_replication.py --render-only
```
