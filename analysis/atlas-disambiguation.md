...
875 cancer papers carry an `FSP1` annotation. Of those,
**242** declare the expansion themselves and so carry a label
that is independent of anything the classifier reads
(110 AIFM2, 132 S100A4, 0 ATL1).

## What PubTator3 does on it

**109/231 = 47.2%** accurate (95% CI 40.8-53.6%).

| paper declares | PubTator assigns | n |
|---|---|---|
| S100A4 | S100A4 | 109 |
| AIFM2 | ATL1 | 99 **wrong** |
| S100A4 | ATL1 | 15 **wrong** |
| AIFM2 | S100A4 | 8 **wrong** |
...
**223/229 = 97.4%** accurate (95% CI 94.4-98.8%), abstaining on 13 of the 242 gold papers.
...
441 papers where this layer disagrees with the single sense
...
|---|---|
| before correction | 98 |
| after correction | 257 |
| recovered | **+159** (162% more) |

So the collision was not a labelling nicety. It was hiding roughly
62% of the census's own
