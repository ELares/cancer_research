...
|---|--:|--:|--:|
| committed analyses (129) | 14 | **1** | 114 |
...
Applying the ferroptosis bucket's body rule to the SAME vocabulary admits **43** analyses. That is not an upper bound on 'other therapy', and an earlier version of this page published it as one. Where those 43 already sit in the table above:
...
**method** (114): listed in `analysis/scope-audit.json`.
