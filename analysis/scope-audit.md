...
|---|--:|--:|--:|
| committed analyses (124) | 14 | **1** | 109 |
...
Applying the ferroptosis bucket's body rule to the SAME vocabulary admits **41** analyses. That is not an upper bound on 'other therapy', and an earlier version of this page published it as one. Where those 41 already sit in the table above:
...
**method** (109): listed in `analysis/scope-audit.json`.
