...
|---|--:|--:|--:|
| committed analyses (127) | 14 | **1** | 112 |
...
Applying the ferroptosis bucket's body rule to the SAME vocabulary admits **42** analyses. That is not an upper bound on 'other therapy', and an earlier version of this page published it as one. Where those 42 already sit in the table above:
...
**method** (112): listed in `analysis/scope-audit.json`.
