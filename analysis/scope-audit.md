...
|---|--:|--:|--:|
| committed analyses (132) | 14 | **1** | 117 |
...
Applying the ferroptosis bucket's body rule to the SAME vocabulary admits **45** analyses. That is not an upper bound on 'other therapy', and an earlier version of this page published it as one. Where those 45 already sit in the table above:
...
**method** (117): listed in `analysis/scope-audit.json`.
