...
|---|--:|--:|--:|
| committed analyses (123) | 14 | **1** | 108 |
...
Applying the ferroptosis bucket's body rule to the SAME vocabulary admits **40** analyses. That is not an upper bound on 'other therapy', and an earlier version of this page published it as one. Where those 40 already sit in the table above:
...
**method** (108): listed in `analysis/scope-audit.json`.
