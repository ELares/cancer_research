...
Applying the ferroptosis bucket's body rule to the SAME vocabulary admits **38** analyses. That is not an upper bound on 'other therapy', and an earlier version of this page published it as one. Where those 38 already sit in the table above:
