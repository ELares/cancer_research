...
|---|--:|--:|--:|
| committed analyses (130) | 14 | **1** | 115 |
...
Applying the ferroptosis bucket's body rule to the SAME vocabulary admits **44** analyses. That is not an upper bound on 'other therapy', and an earlier version of this page published it as one. Where those 44 already sit in the table above:
...
**method** (115): listed in `analysis/scope-audit.json`.
