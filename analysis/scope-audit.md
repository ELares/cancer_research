...
|---|--:|
| ferroptosis-or-physical | 5 |
| therapy-subject | 1 |
| method | 38 |

**5 of them are in this page's own FERROPTOSIS column** (`key-findings`, `pathway-target-audit`, `principle-resistance-tradeoff`, `resistant-state-map`, `timeline`), so under a mutually exclusive bucketing 44 cannot bound the therapy count. A further 38 are method analyses -- instrument work that cites a therapy as a worked example rather than studying one.
