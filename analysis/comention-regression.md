...
fell from 56.8% to 47.1%, about 10 points.**
...
| abstract-visible | 8.2% x 14.6% | 23.7% x 15.0% |
...
* No manuscript number depends on this layer. It feeds
  ...
  should now be read against 47% precision, not 55%.
...
|---|---|---|---|
| both lenient | 56.8% | 49.9% | -7.0 |
| both strict (before scaled by the same 0.56 factor) | 56.3% | 47.1% | -9.2 |
| **as reported (mixed)** | **56.8%** | **47.1%** | **-9.7** |
