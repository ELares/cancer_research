...
**6 dedicated modules, 63 public functions, 816 lines of production code.** Whatever else is true, it is not one function and a configuration struct.
