...
| `chemo` | Cytotoxic chemotherapy: the cell cycle, log kill and scheduling | 19 | 4 | 0 | 282 | 2 |
| `oncolytic` | Oncolytic virus spread | 11 | 1 | 1 | 165 | 2 |
...
|---|---|--:|--:|--:|
| `cell` | CRISPR knockouts | 5 | 165 | 24 |
