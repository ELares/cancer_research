...
- **Most non-census PDFs.** Twenty-nine committed figures come from other
  ...
  the other twenty-four are not, and 16 of those twenty-four `FIGURES.yaml` marks
  ...
  and `fig36_fractionation` read COMMITTED
  ...
  by a thousand left the suite green. The PDFs are still not byte-gated here. Eight of the 16 are drawn by `generate_figures.py` from
  ...
  check and not sufficient for one. The other eight are not blocked that way, and the first
  ...
  needs anyway, being one of the eight below -- would bring it under a
