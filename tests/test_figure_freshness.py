...
- **Most non-census PDFs.** 40 committed figures come from other
  ...
  the other 35 are not, and 27 of those 35 `FIGURES.yaml` marks
  ...
  `fig47_adc_bystander_reach` read COMMITTED
  ...
  by a thousand left the suite green. The PDFs are still not byte-gated here. Eight of the 27 are drawn by `generate_figures.py` from
  ...
  check and not sufficient for one. The other 19 are not blocked that way, and the first
  ...
  needs anyway, being one of the 19 below -- would bring it under a
