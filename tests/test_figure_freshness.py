...
- **Most non-census PDFs.** 34 committed figures come from other
  ...
  the other 29 are not, and 21 of those 29 `FIGURES.yaml` marks
  ...
  `fig39_adoptive_escalation`, `fig40_oncolytic_bind` and
  `fig41_adc_loading` read COMMITTED
  ...
  by a thousand left the suite green. The PDFs are still not byte-gated here. Eight of the 21 are drawn by `generate_figures.py` from
  ...
  check and not sufficient for one. The other 13 are not blocked that way, and the first
  ...
  needs anyway, being one of the 13 below -- would bring it under a
